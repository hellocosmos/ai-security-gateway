...
[0.46: espera de admisión acotada y capacidad de inspección]](docs/es/latency.md) · [Decisión sobre streaming interactivo](docs/es/interactive-streaming.md)
...
> **Open Source Preview 0.46:** todo el runtime y la consola operativa se publican con licencia MIT. El Agent Access Broker integrado está implementado y validado con datos sintéticos, pero permanece **Experimental** hasta validar IdP reales, políticas de clientes, HA y capacidad.
